...
SRC = 	task_user_interface.cpp\
	task_spoke_count.cpp spoke_counter.cpp wheel_encoder.cpp \
	task_pos_controller.cpp pos_controller.cpp motordriver.cpp \
	task_mastermind.cpp mastermind.cpp pot_driver.cpp \
	$(TARGET).cpp
